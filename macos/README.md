...
This is my primary workstation setup. macOS is used for both personal and
professional work, and the tools documented here reflect that everyday workflow.
...
> [Go to essentials.Brewfile](brewfiles/essentials.Brewfile)
...
> [Go to terminal.Brewfile](brewfiles/terminal.Brewfile)
...
> [Go to agent-harnesses-and-sandboxing.Brewfile](brewfiles/agent-harnesses-and-sandboxing.Brewfile)
...
> [Go to connectivity.Brewfile](brewfiles/connectivity.Brewfile)

> Synergy is not yet available through Homebrew.
...
| Virtual machine host | [UTM](https://mac.getutm.app/)<br>(Open Source) | Run Windows and Linux virtual machines for cross-platform validation on my Mac | • [VirtualBox](https://www.virtualbox.org/)<br>• [Parallels](https://www.parallels.com/)<br>• [VMware](https://www.vmware.com/) | I use UTM to host the Windows and Linux VMs documented in this repository |
